...
<header class="team-head">
  ...
  <ul class="team-social list-unstyled">
    ...
    <?php endif; ?>
	<?php if(isset($fields['field_phone_no']->content)): ?>
		<li>
  		<i class="fa fa-phone-square"></i><a href="tel:<?php print $fields['field_phone_no']->content; ?>" target="_blank"><?php print $fields['field_phone_no']->content; ?></a>
		</li>
    <?php endif; ?>
	</ul>
</header>
